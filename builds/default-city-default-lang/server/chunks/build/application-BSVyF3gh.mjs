import { withAsyncContext as withAsyncContext$1, getCurrentInstance, computed, toValue, onServerPrefetch, ref, shallowRef, toRef, nextTick, unref } from 'vue';
import { debounce } from 'perfect-debounce';
import { e as useRoute, h as useRuntimeConfig, m as useState, g as useNuxtApp, k as asyncDataDefaults, l as createError } from './server.mjs';
...
const useApplication = () => {
  ...
  const langRef = useState("lang-code" + lang, () => lang);
  const cityInfoRef = useState("city-info-" + city, () => {
  });
  const catalogRef = useState("catalog-" + city, () => {
  });
  const setCityInfoData = (cityInfo) => {
...
export { useAsyncData as a, useApplication as u, withAsyncContext as w };
//# sourceMappingURL=application-BSVyF3gh.mjs.map
