...
import { toRef, isRef, hasInjectionContext, inject, shallowRef, computed, getCurrentInstance as getCurrentInstance$1, defineComponent, createElementBlock, provide, cloneVNode, h, defineAsyncComponent, unref, shallowReactive, ref, Suspense, Fragment, createApp, createVNode, Text, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, reactive, effectScope, isReadonly, isShallow, isReactive, toRaw, mergeProps, getCurrentScope, withCtx, nextTick, useSSRContext } from 'vue';
import { m as createError$1, r as hasProtocol, s as isScriptProtocol, t as joinURL, w as withQuery, v as sanitizeStatusCode, x as getContext, y as parsePath, z as parseQuery, $ as $fetch$1, A as baseURL, B as createHooks, C as executeAsync, D as toRouteMatcher, E as createRouter$1, F as defu, G as getRequestURL, H as getCookie, I as getRequestHeader, J as destr, K as klona, L as createDefu, M as isEqual, N as withoutTrailingSlash, O as setCookie, P as deleteCookie } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "lang-city",
    path: "/:lang?/:city()",
    component: () => import('./_city_-BNIUj6YC.mjs')
  },
  {
    name: "about-lang-city",
    path: "/about/:lang?/:city()",
    component: () => import('./_city_-xpJeh83w.mjs')
  },
  {
    name: "contacts-lang-city",
    path: "/contacts/:lang?/:city()",
    component: () => import('./_city_-D4ROSzvR.mjs')
  }
];
...
const cityRef = () => useState("city", () => null);
const routerOptions1 = {
  routes: (_routes2) => {
    const { ssrContext } = useNuxtApp();
    const city = cityRef();
    console.log("routes", _routes2);
    if (ssrContext?.event.context.city) city.value = ssrContext?.event.context.city;
    const cityRoute = _routes2.filter((i) => i.path.includes("/:city()"));
    if (city.value) {
      return cityRoute.map((i) => ({
        ...i,
  ...
  ru: [
    {
      ...
      load: () => import(
        './ru-BrkJjU4Z.mjs'
        /* webpackChunkName: "locale_ru_46json_f9c37154" */
      ),
      cache: true
    }
  ]
...
function createNuxtI18nContext(nuxt, vueI18n, defaultLocale) {
  ...
  const loadMessagesFromServer = async (locale) => {
    ...
    const messages = await $fetch(`${"/_i18n/leB-zCKJ"}/${locale}/messages.json`, { headers });
...
const i18n_EI7LsD1KYQADczz5hrChviGQCdVM8yUkvFEZLJpmnvM = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(_nuxt) {
    ...
    prerenderRoutes(localeCodes.map((locale) => `${"/_i18n/leB-zCKJ"}/${locale}/messages.json`));
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-CFuKtyt2.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-B0vWXZpX.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-ZV7DgA0C.mjs'));
...
export { _export_sfc as _, useI18n as a, useSeoMeta as b, cityRef as c, useLocalePath as d, entry_default as default, useRoute as e, useRouter as f, useNuxtApp as g, useRuntimeConfig as h, hashMode as i, nuxtLinkDefaults as j, asyncDataDefaults as k, createError as l, useState as m, navigateTo as n, resolveRouteObject as r, useHead as u };
